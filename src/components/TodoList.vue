...
<template>
  <div class="bg-white w-6/12 rounded-md space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6">
    
    <div class="flex justify-center items-center">
      <h2 class="font-semibold text-slate-900 text-xl uppercase">Todo list</h2>
      <p v-if="todoListCompleted" class="font-semibold text-green-500 lowercase ml-1">completed !</p>
    </div>
